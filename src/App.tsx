...
import { LogIn, LayoutDashboard, Mic2, Music2, PieChart, BarChart3, Clock } from 'lucide-react';
import TopArtists from './components/TopArtists';
import TopTracks from './components/TopTracks';
import GenreDistribution from './components/GenreDistribution';
import Stats from './components/Stats';
import ListeningHabits from './components/ListeningHabits';
import { loginUrl, getAccessToken, fetchTopItems, fetchRecentlyPlayed } from './utils/spotify';
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-black">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-8">Spotify Analytics</h1>
          <a
            href={loginUrl}
